...
def is_game_in_db(sport,date,time,opponent,home_away,team_record,opponent_record,result):
    result=get_game_data(sport,date,time,opponent,home_away,result,team_record,opponent_record,None)
    if not result:
...
def get_game_data(sport,date,time,opponent,at,result,team_record,opponent_record,id):
...
def insert_new_game_data(gd_sport,gd_date,gd_time,gd_opponent,gd_at,gd_result,gd_team_record,gd_opponent_record,gd_id):
    #Insert new game data
    engine.execute(db.insert(games).values(sport=gd_sport,date=gd_date,time=gd_time,opponent=gd_opponent,at=gd_at,result=gd_result,team_record=gd_team_record,opponent_record=gd_opponent_record,id=gd_id))
