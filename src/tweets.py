...
logging,client,delay,team,season,winter_sports,spring_sports,summer_sports,autumn_sports=constants.logging,constants.client,constants.delay,constants.team,constants.season,constants.winter_sports,constants.spring_sports,constants.summer_sports,constants.autumn_sports
    ...
    if games is not None:
        ...
        for game in range(len(games)):
            ...
            if not game_is_exhibiton and game_is_final and not is_duplicate:
                new_tweet=set_tweet(url,sport,opponent,result,game_num)
...
def set_tweet(url,sport,opponent,result,game_num):
    ...
    if win_loss is not None:
        ...
        if team_record is None and opponent_record is None:
            return
        elif win_loss=='W' or win_loss=='T':
