    ...
    if games is not None:
        for game in range(len(games)):
            ...
            if not game_is_exhibiton and game_is_final and not is_duplicate:
                new_tweet=set_tweet(url,sport,date,time,opponent,result)
...
def set_tweet(url,sport,date,time,opponent,result):
    ...
    if win_loss==opponent_score==None:
        ...
        if win_loss=='W':
            tweet="No.\n{}: {} {} defeats {} {} {} to {} {}.".format(
                team_sport,team_record,team,opponent,tech_score,opponent_score,reg_notes
                ) 
        elif win_loss=='T':
            tweet="No.\n{}: {} {} ties {} {} {} to {} {}.".format(
        ...
        if win_loss=='W':
            ...
            tweet = "Yes.\n{}: {} {} defeats {} {} {} to {}.".format(
                team_sport,opponent_record,team_record,opponent,team,opponent_score,tech_score
                )
    return tweet
